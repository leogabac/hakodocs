---
title: "Linux: Laggy suspend"
description: "Laptop is laggy after suspend"
permalink: /linux/laggy-suspend/
redirect_from:
  - /linux.dump.laggy_suspend
---

# Linux: Laptop is laggy after suspend
...
- Using `tlp` for managing battery. See [TLP](/linux/troubleshooting/#tlp) for information on how to install and configure it.
