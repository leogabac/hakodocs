...
See the [HakoDocs TLP section](/linux/troubleshooting/#tlp) for more information on the installation process and setup. Additionally, you can read the [TLP documentation](https://linrunner.de/tlp/index.html).


## Using PPD

The Power Profiles Daemon (PPD) is a common and simple way to manage power profiles on Linux with little or no configuration. On Arch Linux:
```bash
