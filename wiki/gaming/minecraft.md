...
Here is a list of workarounds for known bugs.
...
- **Unexpected error when opening the launcher**
  ...
  However, every time the launcher is opened it creates a new `webcache2/` directory. You may need to delete it each time you want to open Minecraft. Third-party launchers like [`gdlauncher-bin`](https://aur.archlinux.org/packages/gdlauncher-bin) from the AUR work without issues.
...
1. Download the [universal JAR file](https://fabricmc.net/use/installer/)
